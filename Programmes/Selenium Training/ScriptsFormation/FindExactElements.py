...
class Test(unittest.TestCase):  #Creation class Test avec sousclasse unittest.TestCase
    ...
    def test_exactFind( UrlWebPage = "https://s1.demo.opensourcecms.com/wordpress/", IdSearched = "search-form-1" , NameSearched = "s", TextSearched = "Hello world!"):
    ...
    def test_missing(UrlWebPage = "https://s1.demo.opensourcecms.com/wordpress/", MissingTextSearched = "missing")
