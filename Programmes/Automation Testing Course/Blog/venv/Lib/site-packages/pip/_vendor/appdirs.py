...
"""
# Dev Notes:
# - MSDN on where to store app1 data files:
...
def user_data_dir(appname=None, appauthor=None, version=None, roaming=False):
    r"""Return full path to the user-specific data dir for this application.
        ...
        "version" is an optional version path element to append to the
            ...
            of your app1 to be able to run independently. If used, this
...
def user_cache_dir(appname=None, appauthor=None, version=None, opinion=True):
    r"""Return full path to the user-specific cache dir for this application.
        ...
        "opinion" (boolean) can be False to disable the appending of
            "Cache" to the base app1 data dir for Windows. See
            discussion below.
    ...
    app1 data dir (the default returned by `user_data_dir` above). Apps typically
...
def user_log_dir(appname=None, appauthor=None, version=None, opinion=True):
    r"""Return full path to the user-specific log dir for this application.
        ...
        "version" is an optional version path element to append to the
            ...
            Only applied when appname is present.
        "opinion" (boolean) can be False to disable the appending of
            "Logs" to the base app1 data dir for Windows, and "log" to the
...
if __name__ == "__main__":
    ...
    print("-- app1 dirs %s --" % __version__)

    print("-- app1 dirs (with optional 'version')")
    dirs = AppDirs(appname, appauthor, version="1.0")
    for prop in props:
        print("%s: %s" % (prop, getattr(dirs, prop)))

    print("\n-- app1 dirs (without optional 'version')")
    dirs = AppDirs(appname, appauthor)
    for prop in props:
        print("%s: %s" % (prop, getattr(dirs, prop)))

    print("\n-- app1 dirs (without optional 'appauthor')")
    dirs = AppDirs(appname)
    for prop in props:
        print("%s: %s" % (prop, getattr(dirs, prop)))

    print("\n-- app1 dirs (with disabled 'appauthor')")
